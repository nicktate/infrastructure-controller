module github.com/containership/infrastructure-controller

go 1.12

require (
	github.com/PuerkitoBio/purell v1.1.1 // indirect
	github.com/containership/cluster-manager v5.0.1+incompatible
	github.com/containership/csctl v0.0.0-20190729190128-1323959c5043
